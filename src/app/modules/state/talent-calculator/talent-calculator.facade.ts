...
export class TalentCalculatorFacade {
   ...
   */
  loadTalents(classId: number, talentsParam: string = '', glyphsParam: string = ''): void {
    return this.store.dispatch(new TalentCalculatorActions.LoadTalents([classId, talentsParam, glyphsParam]));
  }
  ...
  addGlyph(glyph: Glyph, index: number): void {
    return this.store.dispatch(new TalentCalculatorActions.AddGlyph([glyph, index]));
  }
  ...
  addTalentPoint(talent: Talent): void {
    return this.store.dispatch(new TalentCalculatorActions.AddTalentPoint(talent));
  }
  ...
  removeTalentPoint(talent: Talent): void {
    return this.store.dispatch(new TalentCalculatorActions.RemoveTalentPoint(talent));
  }
  ...
  resetTalentPoints(treeId?: number): void {
    return this.store.dispatch(new TalentCalculatorActions.ResetTalentPoints(treeId));
  }
